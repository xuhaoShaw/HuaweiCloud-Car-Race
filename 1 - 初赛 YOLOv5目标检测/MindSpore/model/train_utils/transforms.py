...
def _preprocess_true_boxes(true_boxes, anchors, in_shape, num_classes, max_boxes, label_smooth,
    ...
    num_layers = anchors.shape[0] // 3  # 3
...
class PreprocessTrueBox:
    def __init__(self):
        self.anchor_scales = np.array([[ 1.25000*8,  1.62500*8],
                                [ 2.00000*8,  3.75000*8],
                                [ 4.12500*8,  2.87500*8],
    ...
    def __call__(self, anno):
        bbox_true_1, bbox_true_2, bbox_true_3, gt_box1, gt_box2, gt_box3 = \
            _preprocess_true_boxes(true_boxes=anno, anchors=self.anchor_scales, in_shape=(1024,1024),
...
class MultiScaleTrans:
    ...
    def __init__(self, config, device_num=1):
        self.config = config
        self.seed = 0
        self.size_list = []
